<?php include('includes/header.php'); ?>
            ...
            <div class="col-md-2">
               <div class="user-info">
                  ...
                  <ul>
                     ...
                     <li><a href="<?php echo BASE_URI; ?>topics.php?user=<?php echo $topic->user_id ?>">View topics</li></a>
                  </ul>
               </div>
            </div>
            <div class="col-md-10">
            ...
            <div class="col-md-2">
               <div class="user-info">
                  ...
                  <ul>
                     ...
                     <li><a href="<?php echo BASE_URI; ?>topics.php?user=<?php echo $reply->user_id; ?>">View Topics</li></a>
                  </ul>
               </div>
            </div>
            <div class="col-md-10">
   ...
   <?php endforeach; ?>
                ...
                <?php if(isLoggedIn()) : ?>
                  <form role="form" method="post" action="singletopic.php?id=<?php echo $topic->id; ?>">
