<?php include('includes/header.php'); ?>
	<form role="form" enctype="multipart/form-data" method="post" action="register.php">
		...
		<div class="form-group">
			...
			<input name="username" type="text" class="form-control" placeholder="Create A Username">
		</div>
		<div class="form-group">
		...
		<div class="form-group">
			...
			<textarea id="about" rows="6" cols="80" name="about" class="form-control" placeholder="Tell us about yourself (Optional)"></textarea>
		</div>
